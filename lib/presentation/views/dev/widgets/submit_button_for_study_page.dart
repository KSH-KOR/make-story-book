...
class SubmitButtonStudyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
      onPressed: () async {
        if(DevDataProvider().studyPageId == null) DevDataProvider().studyPageId = const Uuid().v4();
        ...
        for (var vocab in DevDataProvider().vocabList) {
          await StoryBookService.firebase().createNewVocab(vocab: vocab);
          log("vocab: ${vocab.meaning} added");
        }
        DevDataProvider().clearStudyPageInputs();
